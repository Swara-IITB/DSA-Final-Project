...
double eucl_dist_nodes(Graph& g, ll x, ll y){
...
double unidir_approx_Astar_meet(Graph& g, ll src, ll target, double w, int queries_left, double time_left_ms, double acc_error, double tick_multi){
...
double bidir_approx_Astar_meet( Graph& g, ll src, ll target, double w, int queries_left, double time_left_ms, double acc_error, double tick_multi){
    auto start = std::chrono::high_resolution_clock::now();
    w = 1+w*acc_error;
    if(src==target) return 0.0;
...
double bidir_approx_Astar_range(Graph& g, ll src, ll target, double w,int queries_left, double time_left_ms, double acc_error, double tick_multi){
    auto start = std::chrono::high_resolution_clock::now();
